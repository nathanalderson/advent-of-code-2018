...
class MainSuite extends FunSuite with Matchers {
  ...
  List(
    ...
    ("><", (List(Cart(Point(0,0), W, L), Cart(Point(1,0), E, L)), List(Point(1,0)))),
    (">-<", (List(Cart(Point(1,0), W, L), Cart(Point(1,0), E, L)), List(Point(1,0)))),
    (">>", (List(Cart(Point(1,0), E, L), Cart(Point(2,0), E, L)), List(Point(1,0)))),
